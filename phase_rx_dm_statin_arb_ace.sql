/* Numerator: # of diabetic patients* aged 55-75 who have been prescribed a statin and an ACE or ARB, 
where the medication order is current during the measurement year */
...
INNER JOIN
	...
	INNER JOIN
		...
		AND DATEDIFF(YEAR,person.date_of_birth, patient_encounter.billable_timestamp)>= 55
		AND DATEDIFF (yy, CAST (person.date_of_birth as DATETIME), '2018-06-30') <= 75 
...
AND patient_medication.start_date BETWEEN '2017-07-01' AND '2018-06-30')
